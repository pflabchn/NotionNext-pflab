...
const BLOG = {
  ...
  SINCE: process.env.NEXT_PUBLIC_SINCE || 2018-2025, // e.g if leave this empty, current year will be used.
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '福兰贡芳香实验室', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '学芳疗先找福兰贡', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://falangong.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '芳香疗法,法兰贡,福兰贡,芳疗,精油,芳疗师,国际芳疗师,芳疗培训,IFA芳疗师,NAHA芳疗师,学习芳疗,', // 网站关键词 英文逗号隔开

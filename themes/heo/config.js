const CONFIG = {
  ...
  HEO_NOTICE_BAR: [
    ...
    { title: '加微falangong001，领13万字医芳笔记', url: 'https://docs.tangly1024.com' }
  ],
  ...
  HEO_HERO_CATEGORY_2: { title: '芳疗方案', url: '/tag/芳疗方案' },
  HEO_HERO_CATEGORY_3: { title: '单方精油', url: '/tag/单方精油' },
  ...
  HEO_INFO_CARD_URL3: 'https://www.falangong.cn',
